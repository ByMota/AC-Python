...
try:
    # Classe abstrata Pessoa (não pode ser instanciada)
    pessoa = Pessoa("Minerva McGonagall", "19351004")
    assert pessoa.nome == "Minerva McGonagall"
    print('ERRO...: Classe abstrata Pessoa')
except Exception:
    print('CORRETO: Classe abstrata Pessoa')
    acertos += 1
